...
file_map = {
    ...
    # point absorber
    #(False, False, False, True, False, False, False, True, False, True): ('PAr_1a.csv', 'PA_reactive.csv'),
    #(False, True, False, True, False, False, False, True, False, True): ('PAr_1b.csv', 'PA_reactive.csv'),
    #(True, False, False, True, False, False, False, True, False, True): ('PAr_1c.csv', 'PA_reactive.csv'),
    #(True, True, False, True, False, False, False, True, False, True): ('PAr_1d.csv', 'PA_reactive.csv'),
    (False, False, False, True, False, False, True, True, False, True): ('PAr_2a.csv', 'PA_reg_react.csv'),
    (False, True, False, True, False, False, True, True, True, True): ('PAr_3b.csv', 'PA_stag_react.csv'),

    # oscillating surge
    (False, False, False, False, True, False, False, True, False, True): ('OSr_1a.csv', 'OS_reactive.csv'),
    (False, True, False, False, True, False, False, True, False, True): ('OSr_1b.csv', 'OS_reactive.csv'),
    (True, False, False, False, True, False, False, True, False, True): ('OSr_1c.csv', 'OS_reactive.csv'),
    (True, True, False, False, True, False, False, True, False, True): ('OSr_1d.csv', 'OS_reactive.csv'),
    (False, False, False, False, True, False, True, True, False, True): ('OSr_2a.csv', 'OS_reg_react.csv'),
    (False, True, False, False, True, False, True, True, True, True): ('OSr_3b.csv', 'OS_stag_react.csv'),

    # attenuator
    (False, False, False, False, False, True, False, True, False, True): ('attenr_1a.csv', 'atten_reactive.csv'),
    (False, True, False, False, False, True, False, True, False, True): ('attenr_1b.csv', 'atten_reactive.csv'),
    (True, False, False, False, False, True, False, True, False, True): ('attenr_1c.csv', 'atten_reactive.csv'),
    (True, True, False, False, False, True, False, True, False, True): ('attenr_1d.csv', 'atten_reactive.csv'),
    (False, False, False, False, False, True, True, True, False, True): ('attenr_2a.csv', 'atten_reg_react.csv'),
    (False, True, False, False, False, True, True, True, True, True): ('attenr_3b.csv', 'atten_stag_react.csv')
