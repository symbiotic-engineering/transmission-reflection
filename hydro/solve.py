...
def hydro(array,B,depth,w,char_dim,farm,controls,point_absorber,reactive):
    ...
    if controls == True:
        RAO_controlled, CWR = PTO.RAO(diff_prob,diff_result,dataset,array,w,farm,char_dim,point_absorber,reactive)
