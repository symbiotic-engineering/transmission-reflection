...
def RAO(diff_prob,diff_result,dataset,array,w,reactive,b,B_diffPA,B_diffOS,
                ...
                vir_expForce,fran_expForce,meg_expForce,jo_expForce):
    ...
    ex_force_capy = dif + FK
    print('exforce capy',ex_force_capy)

    ex_force = [vir_expForce/0.05,fran_expForce/0.05,meg_expForce/0.05,jo_expForce/0.05]
    print('exp exforce',ex_force)
